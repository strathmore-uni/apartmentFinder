...
//        System.out.println("Apartment Finder Application Started");

//        // 2. Apartment List Page
//        ApartmentList apartmentListPage = new ApartmentList(container,cardLayout,new SearchData("","",""));
...
//        container.add("specificApartmentPage",specificApartmentPage.createMainPanel());
        ...
        container.add("addApartmentPage",template.getMainPanel());
